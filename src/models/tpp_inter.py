# add additional MLP to learn truncated distribution (i.e., residual distribution)
# after the original tpp model is trained.
import torch
...
class RecurrentTPPInter(nn.Module):
    """
    ...
    Args:
        ...
        seq_id: object iD -> its inter-arrival time mean (target encoding)
    """
    ...
    def __init__(
        ...
        self.mlp_input = self.context_size
    ...
    def get_age_features(self, batch: Batch):
